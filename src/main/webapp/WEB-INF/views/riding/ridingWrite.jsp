	...
	<div class="ridingContainer">
		<form method="post" action="/riding/ridingWriteOk" id="ridingFrm">
			<textarea style="display: none" id="courseSendData"
				name="courseSendData">${rVO.courseSendData}</textarea>
			<ul>
				...
				<li><input type="text" name="ridingKeyword" id="ridingKeyword"
					placeholder="ex)  #순천  #광양" /></li><br>
				<li>
					<div class="btnContainer" id="courseMakeLst">
						<a href="${url}/courseCreate" class="btn btn-1">나만의 코스 만들기</a> <a
							href="${url}/recommendView" class="btn btn-4">추천 코스로 라이딩 만들기</a>
					</div>
				</li>
				<li style="height: 850px;" id="courseInfoLst"><script
						type="text/javascript"
						src="//dapi.kakao.com/v2/maps/sdk.js?appkey=d541fce355c305835dd7871d26048357&libraries=services,clusterer,drawing">
				</script>
					<div id="map" style="width: 100%; height: 500px;"></div>
					<h4>코스 정보</h4> <span>경유지 정보 : </span> <span id="startPoint"></span>&nbsp;-&nbsp;
					...
					<canvas id="myChart" width="1060" height="100"></canvas></li>

				<li id="dateAll">
					<h2>일정</h2> <input type="date" name="startDate" id="startDate">
					- <input type="date" name="endDate" id="endDate">
				</li>

				<li id=courseLevel>
					<h2>난이도</h2> <select id="courseLevel" name="courseLevel"
					class="courseLevel">
				...
				<li><textarea name="ridingContent" id="ridingContent"
							style="min-height: 400px; width: 100%;">${vo.ridingContent }</textarea>
				</li>

    ...
    <section class="memberForm">
        ...
        <form method="post" action="/member/memberOk" id="mFrm" onsubmit="return MemberCheck()">
            <div class="member-input">
                ...
                <label>아이디</label>
                <span id="stateIdChk" class="state" style="font-size: 0.5em; color: #ca2819">아이디를 입력하세요</span>
            </div>
            <div class="member-input">
                <input type="text" name="nickname" id="nickname" onkeyup="CheckNick()" required/>
                <label>닉네임</label>
                <span id="stateNickChk" class="state" style="font-size: 0.5em; color: #ca2819">닉네임을 입력하세요</span>
            </div>
            <div class="member-input">
            ...
            <div class="tel-2">
                ...
                <label>인증번호 입력</label>
                <span id="statePhoneChk" class="state" style="font-size: 0.5em; color: #ca2819">번호 입력 후 인증번호 보내기를 해주십시오.</span>
            </div>
